            ...
            <div class="inline-drawer-content">
                ...
                <div id="${Constants.ID_PAGE_WHITELIST}" class="qr-settings-page">
                    ...
                    <div id="${Constants.ID_WHITELIST_HELP_BOX}" class="qr-whitelist-help-box">
                        ...
                        <p data-i18n="qra_whitelist_help_p4">此外，<i class="fa-solid fa-sun"></i> 表示为小白X脚本，<i class="fa-solid fa-star"></i> 表示为QR，而 <i class="fa-solid fa-moon"></i> 表示为酒馆助手脚本。</p>
                    </div>
                </div>
...
function renderSortLists(settings) {
    ...
    const allItems = [...scripts, ...standard];
